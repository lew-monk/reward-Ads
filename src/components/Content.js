...
import Player2 from "../Images/player-stack.svg";
  ...
  return (
    <div className="">
      ...
      <div className="relative flex justify-between">
        ...
        <div className="relative -mt-32 mr-52">
          <img src={Blob} alt="Blob" className="" />
          <img
            src={Path1}
            alt="path"
            className="absolute -bottom-54 right-52"
          />
        </div>
        <div className="absolute -top-64 left-32 w-96">
          <img src={Player2} alt="" className="" />
        </div>
      </div>
      ...
      <div className="relative flex flex-row-reverse justify-between mt-96">
        <div className="max-w-2xl mr-60 -mt-20">
          ...
          <p className="max-w-sm text-sm font-Mont">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates
            earum tempore repellendus placeat veritatis cupiditate dolore rem
            aspernatur aliquam accusantium doloremque nobis eaque odit
            praesentium eius, ea cum autem sequi?
        ...
        <div className="relative -mt-44 ml-16">
          <img src={Blob} alt="blob" />
          <img src={Path2} alt="path" className="absolute -bottom-80 left-60" />
        </div>
        <div className="w-24">
          <img src={Museum} alt="" className="absolute -top-80 right-60 w-60" />
        </div>
      </div>
      ...
      <div className="relative flex justify-between mt-96">
        ...
        <div className="relative -mt-20 mr-32">
          <img src={Blob} alt="blob" className="z-10 -mt-12 mr-20" />
      ...
      <div className="relative flex flex-row-reverse justify-between mt-60 pt-32">
        ...
        <div className="relative -mt-16 ml-52 pb-10">
        ...
        <img
          src={Cola}
          alt="blob"
          className="absolute -bottom-60 right-96 z-10 w-60 h-auto"
        />
        <img
          src={Path2}
          alt="path"
          className="absolute -bottom-96 left-1/3 z-0"
        />
      </div>
      ...
      <div className="w-11/12 mt-56 flex mx-auto z-10 pt-20">
        <div>
